...
echo "     • Register hooks for enabled AI agent frameworks"
echo "       (Claude Code by default; Qoder / QoderWork / Cursor opt-in)"
echo "     • Create ~/.session-cove/ for hook IPC"
echo ""
echo "  3. Enable additional frameworks (optional):"
echo "     Open Settings → AI 框架 and toggle Qoder / QoderWork / Cursor."
echo "     Each toggle installs / uninstalls that framework's hook entry"
echo "     in ~/.qoder, ~/.qoderwork, or ~/.cursor on demand."
echo ""
echo "  4. Grant Automation permission when prompted:"
echo "     System Settings → Privacy & Security → Automation"
echo "     → Session Cove → iTerm2 ✓"
echo ""
echo "  5. (Optional) Add to Login Items for auto-start:"
